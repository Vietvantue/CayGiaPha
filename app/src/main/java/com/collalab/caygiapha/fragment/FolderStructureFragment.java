...
import com.collalab.caygiapha.holder.IconTreeItemHolder;
import com.collalab.caygiapha.treeview.model.TreeNode;
import com.collalab.caygiapha.treeview.view.AndroidTreeView;

import java.util.List;

public class FolderStructureFragment extends android.support.v4.app.Fragment {
    ...
    private TreeNode.TreeNodeLongClickListener nodeLongClickListener = new TreeNode.TreeNodeLongClickListener() {
        ...
        public boolean onLongClick(TreeNode node, Object value) {
            ...
            parent.getViewHolder().getTreeView().removeNode(node);
            node = new TreeNode(new IconTreeItemHolder.IconTreeItem(R.string.ic_folder,"Fucking Susu"));
